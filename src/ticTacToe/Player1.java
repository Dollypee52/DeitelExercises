...
public class Player1 implements Player {
    ...
    public void play(int position, Value[][] board) {
        if (getBoardElement(position, board) == EMPTY) {
            if (position == 1) board[0][0] = Value.X;
            else if (position == 2) board[0][1] = Value.X;
            else if (position == 3)  board[0][2] = Value.X;
            else if (position == 4)  board[1][0] = Value.X;
            else if (position == 5)  board[1][1] = Value.X;
            else if (position == 6)  board[1][2] = Value.X;
            else if (position == 7)  board[2][0] = Value.X;
            else if (position == 8)  board[2][1] = Value.X;
            else if (position == 9)  board[2][2] = Value.X;
        }
